...
export default function Login() {
  ...
  return (
    <div className="w-full text-gray-900">
      {/* Heading */}
      <div className="mb-8">
        <h1 className="text-[32px] font-bold tracking-tight text-gray-900 mb-2">Sign in</h1>
        <p className="mt-1 text-[13px] text-gray-600">
          New user? <Link href="/register" className="text-[#1473E6] hover:underline font-medium">Create an account</Link>
        </p>
      </div>
      ...
      <div className="space-y-3">
        <Button
          variant="outline"
          className="w-full h-10 font-bold text-[13px] border-gray-300 hover:bg-gray-50 text-[#505050] rounded-full flex items-center justify-center gap-3"
      ...
      <div className="mt-8 text-center space-y-3">
        <Link href="/forgot-password" className="block text-[13px] text-[#1473E6] hover:underline font-medium">
